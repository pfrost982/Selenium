...
suspend fun hopPool(screen: Screen) {
    screen.wait(2.0)
    openUrlSikuliDark(screen, "chrome-extension://cknlgcbdfhknkoidcefkpmlplfndfmll/home.html")
    metamaskUnlock(screen)
    screen.wait(2.0)
    openUrlSikuliDark(screen, "https://goerli.hop.exchange/#/convert?token=ETH&sourceNetwork=linea")
    ...
    openUrlSikuliDark(screen, "https://goerli.hop.exchange/#/pool/deposit?token=ETH&sourceNetwork=linea")
    screen.wait(3.0)
